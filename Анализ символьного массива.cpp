// Анализ символьного массива.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
using namespace std;
#include <iostream>
...
int main()
{
    ...
    const int N = 100;
    char arr[N] = "War Ukkraine and Russia 2022@@2";
